...
<xsl:stylesheet version="1.0" xmlns:java="java:org.fao.geonet.util.XslUtil" 
    ...
    <xsl:template mode="iso19115-3.mgb" match="gex:EX_BoundingPolygon" priority="20">
        <xsl:param name="schema"/>
        <xsl:param name="edit"/>
      
        <xsl:apply-templates mode="iso19115-3.mgb" select="gex:extentTypeCode">
        ...
        <xsl:apply-templates mode="iso19115-3.mgb" select="gex:polygon">
            <xsl:with-param name="schema" select="$schema"/>
            <xsl:with-param name="edit" select="$edit"/>
        </xsl:apply-templates>
    </xsl:template>
    ...
    XML in DataManager.
    -->
    <xsl:template mode="iso19115-3.mgb" match="gex:polygon" priority="20">
        <xsl:param name="schema"/>
        <xsl:param name="edit"/>
    ...
    <xsl:template name="iso19115-3.mgb-global-bbox">
    ...
    <!-- ============================================================================= -->
    <xsl:template mode="iso19115-3.mgb" match="gex:EX_GeographicBoundingBox" priority="2">
        <xsl:param name="schema"/>
        <xsl:param name="edit"/>

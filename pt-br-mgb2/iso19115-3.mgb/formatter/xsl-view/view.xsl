...
<xsl:stylesheet version="2.0"
  ...
  <!-- This formatter render an ISOiso19115-3.mgb record based on the
 ...
 <!-- Required for utility-fn.xsl -->
  ...
  <xsl:include href="../../formatter/jsonld/iso19115-3.mgb-to-jsonld.xsl"/>
  ...
  <xsl:variable name="langId" select="gn-fn-iso19115-3.mgb:getLangId($metadata, $language)"/>
  ...
  <xsl:template mode="getMetadataTitle" match="mdb:MD_Metadata">
    <xsl:for-each select="mdb:identificationInfo/*/mri:citation/*/cit:title">
      <xsl:call-template name="get-iso19115-3.mgb-localised">
  ...
  <xsl:template mode="render-field"
    ...
    <div class="gn-contact">
      ...
      <xsl:for-each select="*/cit:party/(cit:CI_Organisation|cit:CI_Individual)">
        ...
        <div class="row">
          <div class="col-md-6">
            <!-- Needs improvements as contact/org are more flexible in iso19115-3.mgb -->
            <address>
              <strong>
                <xsl:choose>

...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template name="get-iso19115-3.mgb-language">
  ...
  <xsl:template name="get-iso19115-3.mgb-other-languages-as-json">
      ...
      <xsl:choose>
        ...
        <xsl:otherwise>
          <xsl:variable name="mainLanguage">
            <xsl:call-template name="get-iso19115-3.mgb-language"/>
          </xsl:variable>
  ...
  <xsl:template name="get-iso19115-3.mgb-other-languages">
    <xsl:variable name="mainLanguage">
      <xsl:call-template name="get-iso19115-3.mgb-language"/>
    </xsl:variable>
  ...
  <!-- Template used to return a translation if one found, 
    ...
    -->
  <xsl:template name="get-iso19115-3.mgb-localised"
                mode="localised"

...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  xmlns:gn-fn-iso19115-3.mgb="http://geonetwork-opensource.org/xsl/functions/profiles/iso19115-3.mgb"
  ...
  <xsl:template mode="mode-iso19115-3.mgb"
    ...
    <xsl:apply-templates mode="mode-iso19115-3.mgb" select="*|@*">
  ...
  <xsl:template mode="mode-iso19115-3.mgb" match="gn:*|@gn:*|@*" priority="1000"/>
  <!--<xsl:template mode="mode-iso19115-3.mgb" match="mdq:DQ_QuantitativeResult|mdq:value[gco:Record/gco:CodeListValue]" priority="1000"/>-->
  ...
  <xsl:template mode="mode-iso19115-3.mgb" match="gn:child" priority="2000">
    <xsl:param name="schema" select="$schema" required="no"/>
    <xsl:param name="labels" select="$labels" required="no"/>
  ...
  -->
  <xsl:template mode="mode-iso19115-3.mgb" priority="200"
  ...
  <xsl:template mode="mode-iso19115-3.mgb" priority="200"
    ...
    <xsl:variable name="excluded"
                  select="gn-fn-iso19115-3.mgb:isNotMultilingualField(., $editorConfig)"/>
  ...
  <!--
  <xsl:template mode="mode-iso19115-3.mgb" match="*|@*" priority="0"/>
-->
  <!-- Codelists -->
  <xsl:template mode="mode-iso19115-3.mgb" priority="200"
                match="*[*/@codeList]">
    ...
    <xsl:call-template name="render-element">
      ...
      <xsl:with-param name="cls" select="local-name()"/>
      <xsl:with-param name="xpath" select="$xpath"/>
      <xsl:with-param name="type" select="gn-fn-iso19115-3.mgb:getCodeListType(name(), $editorConfig)"/>
  ...
  next template -->
  <xsl:template mode="mode-iso19115-3.mgb" priority="400" match="gml:TimeInstantType"/>

  <!-- the gml element having no child eg. gml:name. -->
  <xsl:template mode="mode-iso19115-3.mgb" priority="300" match="gml:*[count(.//gn:element) = 1]">

...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  prefixed by #.
        -->
  <xsl:function name="gn-fn-iso19115-3.mgb:getLangId" as="xs:string">
    <xsl:param name="md"/>
    <xsl:param name="lang"/>
  ...
  <xsl:function name="gn-fn-iso19115-3.mgb:getCodeListType" as="xs:string">
  ...
  <xsl:function name="gn-fn-iso19115-3.mgb:isNotMultilingualField" as="xs:boolean">
  ...
  <!--
   ...
   -->
  <xsl:function name="gn-fn-iso19115-3.mgb:fillTextElement" as="node()*">
    <xsl:param name="string" as="xs:string"/>
    <xsl:param name="mainLanguage" as="xs:string"/>
    <xsl:param name="useOnlyPTFreeText" as="xs:boolean"/>

    <xsl:copy-of select="gn-fn-iso19115-3.mgb:fillTextElement($string, '\|', '#', $mainLanguage, $useOnlyPTFreeText)"/>
  </xsl:function>

...
-->
  ...
  <xsl:template mode="mode-iso19115-3.mgb"
    ...
    <xsl:call-template name="render-boxed-element">
      ...
      <xsl:with-param name="subTreeSnippet">
        ...
        <xsl:apply-templates mode="mode-iso19115-3.mgb"
  ...
  <xsl:template mode="mode-iso19115-3.mgb" priority="2000" match="mri:*[gco:*/@uom]">
    <xsl:param name="schema" select="$schema" required="no"/>
    <xsl:param name="labels" select="$labels" required="no"/>
 ...
 <!-- <xsl:template mode="mode-iso19115-3.mgb"
    ...
    <div class="row">
      <div class="col-md-8">
        <xsl:apply-templates mode="mode-iso19115-3.mgb" select="cit:date">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="labels" select="$labels"/>
        </xsl:apply-templates>
      </div>
      <div class="col-md-4">
        <xsl:apply-templates mode="mode-iso19115-3.mgb" select="cit:dateType">
          <xsl:with-param name="schema" select="$schema"/>
          <xsl:with-param name="labels" select="$labels"/>
        </xsl:apply-templates>
      </div>
  ...
  <xsl:template mode="mode-iso19115-3.mgb" match="gml:beginPosition|gml:endPosition|gml:timePosition"
                priority="200">
  ...
  <xsl:template mode="mode-iso19115-3.mgb"
                match="*[
                        *[1]/name() = $editorConfig/editor/tableFields/table/@for and
                        ...
                        $isFlatMode]"
                priority="2000">
    <xsl:call-template name="iso19115-3.mgb-table"/>
  </xsl:template>
  ...
  <!-- Define table layout -->
  <xsl:template name="iso19115-3.mgb-table">
